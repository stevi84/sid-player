class C64SidPulseProcessor extends AudioWorkletProcessor {
  /** @type {number} */
  #sampleRate;
  /** @type {number} */
  #syncOffset = 0;
  ...
  process(_inputList, outputList, parameters) {
    ...
    const pulseWidth = parameters.width[0];
    ...
    if (phasePerSample !== 0) {
      for (let i = 0; i < bufferSize; i++) {
        ...
        values[i] = this.#phase < pulseWidth ? -1 : 1;
...
registerProcessor('C64SidPulseProcessor', C64SidPulseProcessor);
